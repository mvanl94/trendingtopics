...
$cfg['blowfish_secret']					= '23\\hW=[V&QGiUddr*8E(+j$&dd3\\Z4c\'' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_cxGu8OqlDy394jfCTUdno1Y/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
