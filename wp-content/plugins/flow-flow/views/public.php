    ...
    (function () {
        ...
        function afterContentArrived ( $ ) {
            ...
            if (FF_resource.scriptDeferred.state() === 'pending' && !FF_resource.scriptLoading) {
                ...
                script.src = "<?php echo $context['plugin_url'] . $context['slug'];?>/js/public.js?ver=<?php echo $version; ?>";
            ...
            if (FF_resource.styleDeferred.state() === 'pending' && !FF_resource.styleLoading) {
                ...
                style.href = "<?php echo $context['plugin_url'] . $context['slug'];?>/css/public.css?ver=<?php echo $version; ?>";
                style.media = "screen";
