...
<div class="section-content" data-tab="addons-tab">
    <div class="section" id="boosts">
        ...
        <div class="desc">Offload your site and put feeds performance to next level by hosting them in our highly optimized cloud. <a href="#" class="ff-pseudo-link boosts-link">How it works?</a><br><span id="ff-cloud-status">Testing connection...</span>
